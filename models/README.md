...
| Stage | Dixon-Coles | XGBoost | CatBoost |
| --- | --- | --- | --- |
| Group stage (48) | 52.1% (25/48) | 52.1% (25/48) | **56.2% (27/48)** |
| Round of 16 (8) | 75.0% (6/8) | **87.5% (7/8)** | **87.5% (7/8)** |
| Quarter-finals (4) | 0.0% (0/4) | 25.0% (1/4) | 25.0% (1/4) |
| Semi-finals (2) | 100% (2/2) | 100% (2/2) | 100% (2/2) |
| Final / 3rd place (2) | 50.0% (1/2) | 50.0% (1/2) | 0.0% (0/2) |

**Takeaways:**

- CatBoost is the best model overall — best accuracy, best RPS, tied Log-Loss with Dixon-Coles. Native categorical handling of confederation features contributes additional signal.
- XGBoost and CatBoost match each other in the Round of 16 (7/8), both superior to Dixon-Coles.
- All models struggle equally in the Quarter-finals — knockout rounds between top teams are inherently hard to predict.
- Both models struggle in the group stage with upsets (Saudi Arabia, Japan, Morocco, Cameroon) that are not predictable from pre-match features alone.
